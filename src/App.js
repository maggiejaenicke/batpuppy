      ...
      <Tabs>
        ...
        <div label="Order the Book">
          <div className="body-text" style={{paddingBottom: '0px', marginTop: '50px'}}>
            Our preorder period has come to a close. Thank you so all for your support! For future updates, join our <a href="https://docs.google.com/forms/d/e/1FAIpQLScNpMEr-deodbKQIALfk4WUQxp7O0Sfpr4PaYLaoFe7ICJlQw/viewform" target="_blank" rel="noopener noreferrer">mailing list. </a><br></br><br></br> 
{/* 
